...
public class Main extends Application {
	...
	*/
	...
	public void start(Stage primaryStage) throws Exception{
		...
		Label lbl = new Label("Software Final Project");
		...
		button2.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				if(txt.getText().equals("Easy")) {
					txt.setText("Normal");
					Game_Content.setNumEnemies(4);
				}
				else if(txt.getText().equals("Normal")) {
					txt.setText("Hard");
					Game_Content.setNumEnemies(5);
				}
				else if(txt.getText().equals("Hard")) {
					txt.setText("Easy");
					Game_Content.setNumEnemies(3);
				}
			}
		});
		...
		String path = "C:\\Users\\joshu\\Downloads\\CSCI2020U-Final-Project-master\\CSCI2020U-Final-Project-master\\The Imperial March.mp3";
		...
		/*
		Scanner s = new Scanner(new File("C:\\Users\\joshu\\eclipse-workspace\\SoftwareDevelopmentProject\\src\\leaderboards.txt"));
